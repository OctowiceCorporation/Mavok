...
class DefaultController extends AbstractController
{
    ...
    public function index(CategoryRepository $categoryRepository, ProductRepository $productRepository, CategoryService $categoryService, EntityManagerInterface $manager)
    {
//        $category = $categoryRepository->findOneBy(['id' => 326]);
//        $cat = new Category();
//        $cat->setParent($category);
//        $cat->setName('uh suka potna katka');
//        $manager->persist($cat);
//        $manager->flush();

        $categories = $categoryRepository->findBy(['parent' => null]);
        $categoryService->generateUrlForAllCategories($categories);
